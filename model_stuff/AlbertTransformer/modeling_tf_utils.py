...
from model_stuff.AlbertTransformer.configuration_utils import PretrainedConfig
from model_stuff.AlbertTransformer.file_utils import cached_path, WEIGHTS_NAME, TF2_WEIGHTS_NAME
from model_stuff.AlbertTransformer.modeling_tf_pytorch_utils import load_pytorch_checkpoint_in_tf2_model
    ...
    def call(self, inputs, training=False):
        ...
        if self.summary_type == 'last':
            ...
            if cls_index is None:
                cls_index = tf.fill(hidden_shape[:-2], hidden_shape[
                    -2] - 1)  # A tensor full of shape [batch] or [batch, num choices] full of sequence length
            ...
            output = tf.squeeze(output,
                                axis=len(hidden_shape) - 2)  # shape of output: (batch, num choices, hidden_size)
