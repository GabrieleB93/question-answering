...
Original file is located at
    https://colab.research.google.com/drive/18tMcmWF3rDg-EB2wjNCxm06fQmBXKMM5
"""
...
def submit(args, model, tokenizer):
    ...
    eval_ds = tf.data.Dataset.from_tensor_slices({
        'input_ids': tf.constant(eval_dataset[0]), # in pratica i token
    ...
    gc.collect()
    candidates = read_candidates(['input/tensorflow2_question_answering/simplified-nq-test.jsonl'], do_cache=False)
